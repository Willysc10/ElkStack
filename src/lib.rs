...
#[derive(Debug)]
pub struct ElkStackProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ElkStackProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ElkStack processing");
    
    let mut processor = ElkStackProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ElkStackProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ElkStackProcessor::new(false);
